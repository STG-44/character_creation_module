...
def attack(char_name: str, char_class: str) -> str:
    ...
    return f'{char_name} Неверное значение'


def defence(char_name: str, char_class: str) -> str:
    """Return result action defence."""
    if char_class == 'warrior':
        return (
            f'{char_name} блокировал' f' {10 + randint(5, 10)} урона'
        )
    if char_class == 'mage':
        return (
            f'{char_name} блокировал' f' {10 + randint(-2, 2)} урона'
        )
    if char_class == 'healer':
        return (
            f'{char_name} блокировал' f' {10 + randint(2, 5)} урона'
        )
    return f'{char_name} Неверное значение'


def special(char_name: str, char_class: str) -> str:
    """Return result action special action."""
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    return 'ренировка окончена.'


def choice_char_class() -> str:
    """Return result changing person class."""
